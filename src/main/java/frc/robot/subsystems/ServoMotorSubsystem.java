...
public abstract class ServoMotorSubsystem extends SubsystemBase {
    ...
    protected ServoMotorSubsystem(final ServoMotorSubsystemConstants constants) {
        ...
        mMaster = new CANSparkMax(mConstants.kMasterConstants.id,null);
        mSlaves = new CANSparkMax(mConstants.kSlaveConstants.length, null);
        ...
        mMaster.setInverted(mConstants.kMasterConstants.invert_sensor_phase);
